view: audit_rule_configuration_charge_level_disposition_type_age_of_record {
  sql_table_name: dbo.Audit_Rule_Configuration_Charge_Level_Disposition_Type_AgeOfRecord ;;
